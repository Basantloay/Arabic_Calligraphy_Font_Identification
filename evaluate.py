'''
    ...
    Pattern Recognition and Neural Networks 
            Pride Class of Fall 2021

    ---------------------------------------
       Arabic Calligraphy Font Detection    
    ---------------------------------------

    Evaluation Script
    @author: Ahmed Salem Elhady
    @date:      25/12/2020
    @updated:   07/01/2022
'''
...
OUTPUT_DIRECTORY = "./output/" ## * Appended Path of outputs
